...
export default function PublicNavbar() {
  ...
  return (
    <nav className="h-20 md:h-24 bg-white/80 backdrop-blur-md border-b border-black/5 fixed top-0 left-0 w-full z-[100]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 h-full flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-4 lg:gap-6">
          <Link href="/login" className="text-sm font-bold hover:text-brand-primary transition-colors">Login</Link>
          <Link href="/register" className="btn-primary px-6 py-3 shadow-xl shadow-brand-primary/10 bg-[#914D00]">Claim My Page</Link>
        </div>
