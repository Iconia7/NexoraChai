...
interface PostUnlockModalProps {
  isOpen: boolean;
  onClose: () => void;
  creator: {
    id: string;
...
export default function PostUnlockModal({
  isOpen,
  onClose,
  creator,
  post,
  ...
  const amount = Number(post.unlockPrice);
  ...
  const handleCheckout = async () => {
    ...
    setLoading(true);
    try {
      const res = await axios.post(`${BACKEND_URL}/api/posts/checkout`, {
        postId: post.id,
      ...
      addToast(err.response?.data?.error || "Post unlock checkout failed", 'error');
      setLoading(false);
    }
  };
          ...
          <div className="overflow-y-auto p-6 md:p-8 no-scrollbar">
              ...
              <>
                <div className="flex items-center justify-between mb-6 sticky top-0 bg-white z-10 py-1">
                  <div className="flex items-center gap-2" style={{ color: primaryColorHex }}>
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest text-zinc-600">Unlock Gated Content</span>
                  </div>
                ...
                <div className="p-4 bg-amber-500/5 rounded-2xl border border-amber-500/10 flex items-center gap-3 mb-6">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] font-bold text-zinc-500 uppercase">One-time Unlock Fee</p>
                  </div>
                </div>
            ...
            {step === 'success' && (
              <div className="py-8 flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-lg font-bold mb-2">Content Unlocked!</h3>
                <p className="text-xs font-semibold text-zinc-500 leading-relaxed mb-6 px-4">
                  Success! Your payment was verified. You can now access this gated post's full content and exclusive attachments.
                </p>
            ...
            {step === 'failed' && (
              <div className="py-12 flex flex-col items-center justify-center text-center">
                ...
                <h3 className="text-lg font-bold mb-2">Unlock Failed</h3>
