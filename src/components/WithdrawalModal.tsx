                ...
                >
                    <div className="p-8">
                        ...
                        <div className="text-center mb-10">
                            <p className="text-[10px] font-black text-brand-muted uppercase tracking-[0.2em] mb-2">Available to Withdraw</p>
                            <h2 className="text-4xl font-black tracking-tight">KES {balance.toLocaleString()}.00</h2>
                        </div>
                        ...
                        <div className="bg-brand-beige-light rounded-3xl p-6 space-y-4 mb-8 border border-black/[0.03]">
                            <div className="flex justify-between items-center text-sm">
                                ...
                                <span className="font-black">KES {balance.toLocaleString()}</span>
                            </div>
                            <div className="flex justify-between items-center text-sm">
                                <div className="flex items-center gap-1.5 font-bold text-brand-muted">
                                    Network Fee <Info size={12} className="opacity-50" />
                                </div>
                                <span className="font-black text-red-500">- KES {networkFee}</span>
                            </div>
                            <div className="pt-4 border-t border-black/5 flex justify-between items-center">
                                <span className="font-black uppercase tracking-widest text-[10px] text-brand-muted">Total to Receive</span>
                                <span className="text-xl font-black text-[#00A65A]">KES {netAmount.toLocaleString()}.00</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <button 
                                ...
                                className="w-full bg-black text-white py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] flex items-center justify-center gap-3 hover:bg-brand-primary transition-all disabled:opacity-50 shadow-xl shadow-black/10"
                            >
