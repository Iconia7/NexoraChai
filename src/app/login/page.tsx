    ...
    <div className="min-h-screen bg-[#050A15] flex items-center justify-center px-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400">Continue building your creator empire.</p>
        </div>
        ...
        <p className="text-center mt-10 text-slate-400 font-medium">
          Don't have an account? <Link href="/register" className="text-accent hover:underline">Sign up for free</Link>
        </p>
      </motion.div>
    </div>
  );
