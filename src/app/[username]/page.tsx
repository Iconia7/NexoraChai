        ...
        <div className="max-w-xl mx-auto px-6">
           ...
           <div className="relative -mt-24 flex flex-col items-center text-center mb-10">
              ...
              <div className="flex items-center gap-2 mb-2 justify-center">
                ...
                <Sparkles size={20} style={{ color: primaryColorHex }} />
              </div>
           ...
           {/* Animated Tab Bar */}
           <div className="flex justify-center border-b border-black/[0.05] dark:border-white/[0.05] mb-8 overflow-x-auto scrollbar-none py-2 gap-2">
             {tabs.map((tab) => {
               ...
               return (
                 <button
                   ...
                   className="relative px-5 py-3 rounded-xl text-sm font-bold tracking-wide transition-all duration-200 flex items-center gap-2 select-none"
                   style={{
